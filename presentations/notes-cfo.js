...
module.exports = {
  ...
  "what-is-finops":
    ...
    "rather than an annual exercise. The reason it is a cycle rather than a project is that the " +
    "estate changes continuously — an allocation model that was accurate in January describes a " +
  ...
  "why-visibility":
    ...
    "capital sitting idle. Accurate allocation is what makes a budget owner genuinely " +
    "accountable rather than nominally so. The bottom line is the argument against the " +
    "alternative: without allocation the only available lever is an across-the-board reduction, " +
  ...
  "framework":
    ...
    "to dwell on: cost per customer, per transaction, per active user is what separates 'spend is " +
    "up twenty percent' from 'spend per customer is down eight' — the same invoice, opposite " +
    "stories, and only the second one belongs in a margin discussion. Daily data matters for the " +
  ...
  "shared-resources":
    ...
    "headcount or an equal split, because it survives the conversation. Second, freeze it for the " +
    "fiscal year and document it; a method that changes mid-year makes every period-over-period " +
    "comparison unusable and invites the argument you were trying to end. Note the technical " +
    "caveat, because it constrains what we can promise: a shared platform carries a single set of " +
  ...
  "commitments":
    ...
    "over-committing means prepaying for a peak that does not return. Both are visible only if " +
    "coverage and utilization are reported separately: coverage says how much of steady-state " +
    "spend sits under a commitment, utilization says whether what we bought is being used. " +
    "Unused commitment is the worst line on this slide, because it is already spent, cannot be " +
    "released, and is invisible on any report priced at list. Also make the reporting point: " +
  ...
  "multi-cloud":
    ...
    "licence cost with no incremental answer. The durable point is FOCUS: it is a common chart of " +
    "accounts across vendors, and asking for FOCUS-compliant exports in the next contract renewal " +
  ...
  "showback-chargeback":
    ...
    "allocation is trusted and fatal to the programme if it is not — the failure mode is a " +
    "quarter spent arguing about the numbers rather than about the spend, after which nobody " +
    "believes the report. Hence the sequencing: showback until allocation coverage is high and " +
    "stable, then chargeback at a fiscal-year or half-year boundary so budgets are set with the " +
  ...
  "best-practices":
    ...
    "other two are controls rather than metrics — cost review inside the design process, and " +
    "policy that blocks expensive configurations before they are deployed, which is the closest " +
    "thing here to a spending approval gate. Score each as in place, partial or absent for our " +
  ...
  "path-forward":
    ...
    "every downstream report degrades if the taxonomy is still moving. Split the ownership " +
    "explicitly — finance owns the taxonomy, the allocation policy and the KPI definitions; " +
    "engineering owns enforcement, instrumentation and remediation. Steps two and four are both " +
    "arguments for restraint: attack the largest cost categories rather than pursuing complete " +
  ...
  "takeaways":
    ...
    "subsequent period. That is also the honest framing for the board: the near-term deliverable " +
    "is explainable variance and a forecast we can stand behind, with targeted savings following " +
    "the first full period of clean data. Ask for the first two links today — the allocation " +
