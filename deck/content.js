...
module.exports = [
  ...
  },
  {
    ...
    stats: [
      { label: "Total, Jan-Jul", value: "auto:total", note: "2.6x regular AWS usage", accent: AWS },
  ...
  },
  {
    ...
    notes: {
      title: "What moved",
      items: [
        "GitHub and Cowork drive most of the July step-up",
  ...
  },
  {
    ...
    foot: "Dev/Test costs more than Production every month of the period. Virtual machines are roughly three quarters of the bill and barely vary, a flat and reservable profile.",
  },
  {
    kind: "dualChart",
  ...
  },
  {
    ...
    foot: "Most of what is tagged AI Factory is infrastructure rather than inference. That is not automatically wrong, since models need somewhere to run, but it is the part right-sizing can move.",
  },
  {
    kind: "chart",
  ...
  },
  {
    ...
    foot: "Opus-class models are the overwhelming majority of Bedrock spend. Model mix changes month to month, with Opus 5 appearing in July, which is exactly what a model policy is for.",
  },
  {
    kind: "chart",
  ...
  },
  {
    ...
    charts: [
      ...
      { id: "chart42", title: "Cowork, by subscription", type: "stacked", top: 3 },
    ],
    stats: [
      { label: "GitHub, May-Jul", value: "auto:total:chart43", note: "auto:change:chart43", accent: AI },
      { label: "Cowork, July", value: "auto:last:chart42", note: "first full month billed", accent: COLORS.cyan },
      { label: "Combined", value: "auto:total:chart43+chart42", note: "developer AI, three months", accent: COLORS.muted },
    ],
    foot: "GitHub triples between May and July. Cowork credits appear for the first time in July at $8,919, no credit applied, billed in full.",
  },
