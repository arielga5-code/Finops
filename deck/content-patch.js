...
module.exports = [
  ...
  /* ============================= slide 19 ============================= */
  {
    ...
    stats: [
      ...
      {
        label: "Unexplained credit",
        value: "$16,100",
        note: "reversed against a charge nobody can identify",
        accent: AWS,
      },
      {
    ...
    speakerNotes: [
      "The mesh is the argument. Five consumer groups, five providers, nothing in",
      "the middle. Twenty-five direct paths, no single place that can see the spend,",
