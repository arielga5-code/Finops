...
const core = [
   ...
   * ================================================================ */
  {
    ...
    accent: COLORS.cyan,
    speakerNotes: [
      "TWO BASES IN THIS DECK — say which one you are on, every time.",
      "",
      "1. Invoiced, May-Jul. What the three clouds billed. This is v33's basis and it",
      "   drives the run-rate and the December projection.",
      "2. Consumption, Jan-Jul. What the operational workbooks metered, seven months.",
      "   Used for trend, cost-centre detail and the savings numbers.",
      "",
      "They differ slightly (Commvault prepayment excluded from the invoiced view,",
      "and timing). Same estate either way.",
    ].join("\n"),
  },

  {
    ...
    speakerNotes: [
      ...
      "",
      "  Azure    186,541",
      "  AWS       92,930   (gross, before the $16,100 credit)",
      "  GCP        3,850",
      "  ------------------",
      "  July     283,322   per month",
      "  x 12   3,399,859   per year   ->  $3.4M",
      "",
      "If July repeats for a full year, we are at a $3.4M pace. That is all it says.",
      "",
      "WHERE THE $641K COMES FROM",
      "  May    229,908 x 12 = 2,758,896",
      "  July   283,322 x 12 = 3,399,859",
      "  difference              640,963   = +23.2%",
      "",
      "In three months the annual pace rose by about $641K.",
    ].join("\n"),
  },

  {
    ...
    speakerNotes: [
      "ALL THREE START FROM THE SAME PLACE: July at 283,322 a month.",
      "The only difference is what growth rate you carry forward for five months.",
      "",
      "1. FLAT — no growth.",
      "     283,322 x 12 = $3.40M",
      "",
      "2. MAY-JUL RATES (this is v33's number).",
      "   Rates measured over two months, May to July:",
      "     Azure  145,254 -> 186,541  = +13.3% per month",
      "     AWS     83,062 ->  92,930  =  +5.8% per month",
      "     GCP                          +$1.1K per month",
      "   Carry to December:  481,097 per month  x 12 = $5.77M",
      "",
      "3. JAN-JUL RATES.",
      "   Same maths, six months of data instead of two:",
      "     Azure  156,990 -> 186,917  = +3.0% per month",
      "     AWS     77,126 ->  92,930  = +3.2% per month",
      "   Carry to December:  ~333,900 per month  x 12 = $4.01M",
      "",
      "WHY THE GAP: May was the softest month of the year. Measuring growth from a",
      "trough makes a rebound look like a trend. Both rates are real; only one is",
      "sustained. August and September settle it.",
      "",
      "If asked what to plan on: the middle case, $4.0M.",
    ].join("\n"),
  },
   ...
   * ================================================================ */
  {
    ...
    accent: AZURE,
    speakerNotes: "From here to the GCP slide everything is May-Jul invoiced, except the seven-month context slide, which is labelled on its face.",
  },

  {
    ...
    speakerNotes: [
      ...
      "  Total  500,216",
      "",
      "  +28.4% = 186,541 / 145,254 - 1   (May to July, not month-on-month)",
      "",
      "THE AI FIGURES",
      "  $192,935 = every AI and data-platform meter across the same three months.",
      "  +62.5%   = growth of that AI figure, May to July.",
      "  32.1%    = AI share of JULY consumption. It was 26.4% in May.",
      "             Across the full three months the share is 30.5%.",
      "",
      "The point: the bill grew 28%, AI grew 63%. AI is pulling the total up.",
      "",
      "Commvault's annual prepayment is excluded so the line reads as run-rate,",
      "not as a one-off cash spike.",
    ].join("\n"),
  },

  {
    ...
    stats: [
      { label: "Consumption, Jan–Jul", value: "$1.73M", note: "≈ $3.0M annualised", accent: COLORS.cyan },
      { label: "March to July", value: "+8.5%", note: "four months, barely moved", accent: COLORS.good },
      { label: "May to July", value: "+19.8%", note: "the window v33 projects from", accent: COLORS.danger },
    ],
    ...
    speakerNotes: [
      "SEVEN MONTHS OF METERED CONSUMPTION, all three clouds added up per month.",
      "",
      "  Jan 234,116   Feb 218,324   Mar 261,455   Apr 234,946",
      "  May 236,775   Jun 256,207   Jul 283,554",
      "",
      "  Jan-Jul total   1,725,377",
      "  / 7 x 12        2,957,788   ->  ~$3.0M annualised",
      "",
      "THE TWO PERCENTAGES",
      "  Mar -> Jul   283,554 / 261,455 - 1 = +8.5%   (four months)",
      "  May -> Jul   283,554 / 236,775 - 1 = +19.8%  (two months)",
      "",
      "Same estate, same data. Pick March as your start and growth looks mild; pick",
      "May and it looks alarming. That is the whole argument for showing a range on",
      "the previous slide.",
      "",
      "AWS July is gross here (92,930) so it lines up with slide 2. Net of the",
      "$16,100 credit it is 76,830, and the Jan-Jul total is $1.71M.",
    ].join("\n"),
  },
